...
- Latest required scoped audit: **3.5/spells at 887 reviewed effects**. Source gate: **5,035 / 5,035**, zero failures and zero critical source gaps. Candidate output gate: **1,540 / 5,035 output-complete / 3,495 incomplete**, **30.5859%** output-complete. The only remaining failure class was the expected unresolved `effect/effectSummary` backlog. Source and output gates remain independent; live/catalog writes stay locked until overall release criteria are met.
