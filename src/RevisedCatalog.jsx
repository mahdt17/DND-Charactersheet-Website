...
export default function RevisedCatalog({show}) {
  ...
  return <section aria-label="Revised 5e catalog"><p>5.5e / 2024 SRD references. Choose 5.5e in character setup to use revised class progression, species and spell rules.</p><div className="l-list-controls">
