...
export default function EditionSpellbook({char,patch,roll,show,homebrew=[]}) {
  const [manage,setManage]=useState(false),[cast,setCast]=useState(null),[slot,setSlot]=useState(1),[formula,setFormula]=useState(''),[attack,setAttack]=useState(false),[castError,setCastError]=useState('');
