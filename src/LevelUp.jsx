...
export default function LevelUp({char,homebrew=[],onFinish,onCancel}) {
  ...
  function finish(classResult) {
    ...
    const advanced=applyCastingAdvancementSelections(advancedBase,castingPlan,castingTargets);
