...
const report={
  ...
  sourceDataCoverage:{
    ...
    proficiencyProgressionGrants:verifiedProficiencyEntries.reduce((n,entry)=>n+(entry.proficiencyProgression?.length||0),0),
    sourceOnlyProficiencies:verifiedProficiencyEntries.reduce((n,entry)=>n+(entry.proficiencies||[]).filter(item=>item.sourceOnly).length,0),
